...
- 실습1 [노트북](./day01/mldl01_도미빙어분류.ipynb)
...
- `데이터` 세트 : 훈련 후 모델이 예측을 제대로 하는지 테스트하는 데이터
...
- 2차원 배열이상 고차원 배열 처리 조작 처리 간편한 도구

- 실습 [노트북](./day01/mldl02_훈련테스트세트.ipynb)
...
- [모율 실습 노트북](./day02/m ldl01_주요모듈학습.ipynb)
